...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">روان شناسی</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">خانه</a></li>
                <li class="breadcrumb-item"><a href="#">صفحه ها</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">روان شناسی</li>
            </ol>
        </nav>
    </div>
</div>
...
<div style="background-image: url('https://cdn.downloadefilm.ir/images/bc9d7d20-5ab2-11ee-9d86-695834c9c04f.jpg')">
...
<br> <h1>روان شناسی</h1></br>
<video id="video1" width="420">
<source src="video/moive8.mp4" type="video/mp4">
<source src="video/moive8.mp4" type="video/ogg">
