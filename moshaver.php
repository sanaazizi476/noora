...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">مشاور</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">خانه</a></li>
                <li class="breadcrumb-item"><a href="#">صفحه ها</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">مشاور</li>
            </ol>
        </nav>
    </div>
</div>
...
<div style="background-image: url('https://www.zibamoon.com/Files/Thumbs/2021/5/30/%D8%AA%D8%B5%D9%88%DB%8C%D8%B1-%D8%B2%D9%85%DB%8C%D9%86%D9%87-%D8%A2%D8%A8%DB%8C-1.webp')">
...
<source src="video/moive6.mp4" type="video/mp4">
<source src="video/moive6.mp4" type="video/ogg">
