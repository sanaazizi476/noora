...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">ادبیات</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">خانه</a></li>
                <li class="breadcrumb-item"><a href="#">صفحه ها</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">ادبیات</li>
            </ol>
        </nav>
    </div>
</div>
...
<div style="background-image: url('https://wallino.com/wp-content/uploads/2022/08/W12021600-B-%E2%80%8C%E2%80%8C%E2%80%8C00.jpg')">
...
<source src="video/moive7.mp4" type="video/mp4">
<source src="video/moive7.mp4" type="video/ogg">
