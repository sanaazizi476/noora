...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">مهندسی عمران </h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">خانه</a></li>
                <li class="breadcrumb-item"><a href="#">صفحه ها</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">مهندسی عمران</li>
            </ol>
        </nav>
    </div>
</div>
                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style="min-height: 400px;">
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded" src="https://sabavisa.com/wp-content/uploads/2023/11/%D8%AA%D8%AD%D8%B5%DB%8C%D9%84-%D8%B1%D8%B4%D8%AA%D9%87-%D9%85%D9%87%D9%86%D8%AF%D8%B3%DB%8C-%D8%B9%D9%85%D8%B1%D8%A7%D9%86-%D8%AF%D8%B1-%D9%87%D9%84%D9%86%D8%AF-540x360.webp" style="object-fit: cover;">
                            </div>
                        </div>
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <h1 class="mb-4">رشته مهندسی عمران  چیست؟</h1>
                               <p>شته مهندسی عمران یکی از رشته‌های شاخه مهندسی است که به ساخت و ساز و طراحی سازه‌های طبیعی می‌پردازد. این رشته جزو رشته‌های محبوب گروه ریاضی محسوب می‌شود و داوطلبان زیادی علاقه دارند در این رشته قبول شوند. رشته مهندسی عمران جزو رشته‌های 1 زیرگروه ریاضی است و درس ریاضی مهم‌ترین نقش را در رتبه نهایی داوطلبان ایفا می‌کند. این رشته در مقاطع کارشناسی، ارشد و دکتری دارای گرایش‌های متنوعی است و داوطلبان می‌توانند
                                 با توجه به علاقه خود در یکی از گرایش‌های این رشته تحصیل کنند</p>
                        </div>
                    </div>
                </div>
            </div>
